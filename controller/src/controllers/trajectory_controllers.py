...
class YumiTrajectoryController(YumiDualController):
    ...
    def _callback_trajectory(self, data: Trajectory_msg):
        ...
        for point in data.trajectory:
            ...
            if relative: 
                pos_1 = pos_1 + trajectory[-1].param.pose_right.pos
            ...
            if relative:
                rot_1 = rot_1 * trajectory[-1].param.pose_right.rot
            ...
            if relative: 
                pos_2 = pos_2 + trajectory[-1].param.pose_left.pos
            ...
            if relative:
                rot_2 = rot_2 * trajectory[-1].param.pose_left.rot
            # set the grippers
            grip_r = point.gripperRight
            if relative:
                grip_r = grip_r + trajectory[-1].param.grip_right
            grip_l = point.gripperLeft
            if relative:
                grip_l = grip_l + trajectory[-1].param.grip_left
