...
class EmulationBase(object):
    def __init__(self, odom_frame):
        ...
        rospy.Timer(rospy.Duration(self._update_period), self._callback_update_odometry)
    ...
    def _callback_update_odometry(self, event):
