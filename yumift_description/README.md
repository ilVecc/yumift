...
The URDF file is from https://github.com/kth-ros-pkg/yumi/tree/egm_modifications/yumift_description. 
...
Load the URDF with
```
roslaunch yumift_description load.launch
```

Visualize the URDF in Rviz with
```
roslaunch yumift_description view.launch
```
